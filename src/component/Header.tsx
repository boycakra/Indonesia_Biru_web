      ...
      <header>
        <nav className="navbar">
          ...
          <div className="navbar-container">
            ...
            <li>
              <a
                href="https://drive.google.com/drive/folders/1m9PjTnd3jEj5ktqaHemsiKiwk-VPI2Ro"
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => updateValue("Free Resources")}
              >
                Free Resources 
              </a>
            </li>
            ...
            <div className='container-burger-menu'>
              ...
              >
                 <div
                className="txt-burger-menu"
                onClick={() => handleClick("Free Resources")}
              >
                <a
                  href="https://drive.google.com/drive/folders/1m9PjTnd3jEj5ktqaHemsiKiwk-VPI2Ro"
                  target="_blank"
